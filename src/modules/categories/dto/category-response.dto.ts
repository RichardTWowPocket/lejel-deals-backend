...
export class CategoryHierarchyResponseDto {
  ...
  @ApiProperty({ description: 'Category path in hierarchy', example: 'food/beverage' })
  path: string;
...
export class CategoryResponseDto {
  ...
  @ApiPropertyOptional({ description: 'Category path in hierarchy', example: 'food/beverage' })
  path?: string;

  @ApiPropertyOptional({ description: 'Category sort order within level', example: 1 })
  sortOrder?: number;

  @ApiProperty({ description: 'Category tags', example: ['food', 'restaurant', 'delivery'] })
  tags: string[];

  @ApiPropertyOptional({ description: 'Category metadata', example: { featured: true, priority: 1 } })
  ...
  @ApiPropertyOptional({ description: 'Category hierarchy information', type: CategoryHierarchyResponseDto })
