...
export declare class MerchantsController {
    ...
    findAll(page: number, limit: number, search?: string, city?: string, isActive?: string): Promise<{
        data: {
            totalDeals: number;
            activeDeals: number;
            totalOrders: number;
    ...
    search(query: string, city?: string, isActive?: string): Promise<({
        _count: {
            deals: number;
        };
    } & {
    ...
    update(id: string, updateMerchantDto: UpdateMerchantDto, user: AuthUser): Promise<{
        totalDeals: number;
        activeDeals: number;
        totalOrders: number;
        _count: {
    ...
    updateVerification(id: string, verificationDto: MerchantVerificationDto, user: AuthUser): Promise<{
        id: string;
        name: string;
        description: string | null;
        isActive: boolean;
    ...
    getVerificationStatus(id: string): Promise<{
        merchantId: string;
        status: import("./dto/merchant-verification.dto").VerificationStatus;
        verifiedAt: Date | null;
        notes: string;
    }>;
    updateOperatingHours(id: string, operatingHours: any[], user: AuthUser): Promise<{
        operatingHours: any[];
        totalDeals: number;
        activeDeals: number;
        totalOrders: number;
    ...
    getStats(id: string, user: AuthUser): Promise<{
        merchantId: string;
        totalDeals: number;
        activeDeals: number;
        totalOrders: number;
    ...
    getPayouts(id: string, period?: 'day' | 'week' | 'month' | 'year' | 'all', user?: AuthUser): Promise<{
        merchant: {
            id: string;
            name: string;
        };
