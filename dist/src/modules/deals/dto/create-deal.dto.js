...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        example: 'Pizza Voucher Rp 50.000',
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        example: 'Voucher senilai Rp 50.000 untuk semua menu pizza. Berlaku untuk makan di tempat dan dibawa pulang.',
    }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        description: 'Price customer pays to buy the coupon (IDR)',
        example: 40000,
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        ...
        default: client_1.DealStatus.DRAFT,
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Coupon face value in IDR',
        example: 50000,
    }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Filter featured deals only',
        example: true,
    }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Minimum deal price in IDR',
        example: 10000,
    }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Maximum deal price in IDR',
        example: 100000,
    }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
