...
export declare class DealsController {
    ...
    findAll(page: number, limit: number, status?: DealStatus, merchantId?: string, categoryId?: string, search?: string, featured?: boolean, city?: string, priceMin?: string, priceMax?: string, minPrice?: string, maxPrice?: string, sortBy?: string, sortOrder?: 'asc' | 'desc'): Promise<DealListResponseDto>;
